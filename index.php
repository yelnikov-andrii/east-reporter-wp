        ...
        <div class="main-top__block">
            <div class="main-top__banner">
                ...
                <div class="youtube-placeholder" data-video-id="<?php echo $video_id; ?>">
                    <?php if ($video_id): ?>
                        <img 
                           srcset="https://img.youtube.com/vi/<?php echo $video_id; ?>/default.jpg 120w,
                           https://img.youtube.com/vi/<?php echo $video_id; ?>/mqdefault.jpg 320w,
                           https://img.youtube.com/vi/<?php echo $video_id; ?>/hqdefault.jpg 480w"
                           sizes="(max-width: 480px) 120px, (max-width: 768px) 320px, 480px" alt="Video Thumbnail">
