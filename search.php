    ...
    <div class="container news__container">
        ...
        <div class="news__block">
            <div class="news__list">
                ...
                <aside class="news__aside news-article-aside">
                    <div class="news-article-aside__block">
                        <h2 class="news-article-aside__h2">Recent posts</h2>
                        <div class="news-article-aside__list">
                            <?php
                            $recent_posts = wp_get_recent_posts(array('numberposts' => 4));
                            foreach ($recent_posts as $post) {
                                echo '<a href="' . get_permalink($post["ID"]) . '" class="news-article__link news-article-aside__link">';
                    ...
                    <div>
                        <h2 class="news-article-aside__h2">Categories</h2>
                        <div class="news-article-aside__list">
                            <?php
                            // Вывод категорий
                            $categories = get_categories();
                            foreach ($categories as $category) {
                                echo '<a href="' . get_category_link($category->term_id) . '" class="news-article__link news-article-aside__link">';
